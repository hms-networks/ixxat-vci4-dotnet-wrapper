...
namespace Ixxat.Vci4.Bal.Can 
{
  ...
  *************************************************************************/
  ...
  /// </example>
  //*****************************************************************************
  public interface ICanControl2 : ICanSocket2
  {
    //*****************************************************************************
    /// <summary>
    ...
    /// </exception>
    //*****************************************************************************
    int   DetectBaud  ( CanOperatingModes         operatingMode
                      , CanExtendedOperatingModes extendedMode
                      , ushort timeout, CanFdBitrate[] bitrateTable);
    ...
    /// </exception>
    //*****************************************************************************
    void  InitLine    ( CanOperatingModes operatingMode
                      , CanExtendedOperatingModes extendedMode
