...
static const BYTE can_dlc2len[] = {0, 1, 2, 3, 4, 5, 6, 7,
                                   8, 12, 16, 20, 24, 32, 48, 64};

static const BYTE can_len2dlc[] = {0, 1, 2, 3, 4, 5, 6, 7, 8,         /* 0 - 8 */
                                   9, 9, 9, 9,                        /* 9 - 12 */
                                   10, 10, 10, 10,                    /* 13 - 16 */
                                   11, 11, 11, 11,                    /* 17 - 20 */
                                   12, 12, 12, 12,                    /* 21 - 24 */
...
//*****************************************************************************
/// <summary>
///   This value class represents a CAN FD message. CAN FD messages can be received
...
/// </example>
//*****************************************************************************
public value class CanMessage2 : public ICanMessage2
{
  //--------------------------------------------------------------------
  // member variables
  //--------------------------------------------------------------------
  private:
    static CanMessage2 ms_EmptyMsg;

  internal:
    mgdCANMSG2 m_CanMsg; // CAN message structure
  ...
  public:
    ...
    virtual property Byte default[int] 
    {
      ...
      Byte get(Int32 index) sealed
      {
        ...
        {
          pin_ptr<mgdCANMSG2> pMngtMsg = &m_CanMsg;
          return( ((PCANMSG2)pMngtMsg)->abData[index] );
        }
        else
        {
      ...
      void set(Int32 index, Byte value) sealed
      {
        ...
        {
          pin_ptr<mgdCANMSG2> pMngtMsg = &m_CanMsg;
          ((PCANMSG2)pMngtMsg)->abData[index] = value;
        }
        else
        {
          throw gcnew ArgumentOutOfRangeException("index");
  ...
  public:
    ...
    virtual void Clear()
    {
      static CANMSG2 Empty = {0};
      pin_ptr<mgdCANMSG2> pMsg = &m_CanMsg;
      *(PCANMSG2)pMsg = Empty;
    };
    ...
    virtual bool Equals(Object^ obj) override
    {
      ...
      size_t length = sizeof(mgdCANMSG2);
      if (CanMsgFrameType::Data == p->FrameType)
      {
        length += p->DataLength;
      }

      mgdCANMSG2 msg = p->ToCANMSG2();
      pin_ptr<mgdCANMSG2> pMsg1 =  &msg;
      pin_ptr<mgdCANMSG2> pMsg2 =  &m_CanMsg;
      ...
      case CanMsgFrameType::Data:
        {
          ...
          {
            for(int iDataIdx = 0; iDataIdx < Math::Min(DataLength, (Byte)CAN_ELEN_MAX); ++iDataIdx)
            {
    ...
    void SetValue(mgdCANMSG2 rawmsg)
    {
      m_CanMsg = rawmsg;
    }
};
